...
if args.display:
        # Use shared plotting helper for consistent visuals
        my_utils.plot_tree_3d(coords, colors=[(0,0,255)], point_size=20, show=True, title="Triangulated 3D Coordinates")
